			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.TianYing.model.Order o=(com.TianYing.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							System.out.println(con);
							com.TianYing.dao.UserDao userDao=new com.TianYing.dao.UserDao();
						...
						<%
							...
							String paymentType=com.TianYing.model.Payment.findByPaymentId(con,n);
							 %>
